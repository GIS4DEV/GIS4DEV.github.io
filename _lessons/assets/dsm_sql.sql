...
FROM wards, census  --re-reading this, I think it should be just "FROM census". SQL already knows the wards table is involved based on the first line, "UPDATE wards"
