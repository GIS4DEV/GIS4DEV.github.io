...
- Office: McCardell Bicentennial Hall 6th Floor: room 634, GIS lab, or conference room
...
5. Post a new [course issue](https://github.com/GIS4DEV/GIS4DEV.github.io/issues) or issue on the specific repository we are working on.
...
- **Blog Posts & Active Participation** `0.2` (routine)
  ...
  - Working with an open science ethos means openly sharing your challenges and discoveries in person during lab and online using the course [Issues](https://github.com/GIS4DEV/GIS4DEV.github.io/issues) or Issues on specific repositories we are working on.
